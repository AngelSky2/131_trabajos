...
public class GenericLinkedList {
	...
	static class CircularLinkedList {
		...
		public static void main(String[] args) {
			...
			System.out.println("LISTA ORIGINAL");
			doblecircular.display();
			rotarListaCircualr(doblecircular);
			System.out.println("==============================================");
		}

		private static void rotarListaCircualr( DoubleCircularLinkedList doblecircular) {
		...
		private static void dividirLista(GenericLinkedList.CircularLinkedList simplecircular) {
